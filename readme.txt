...
Adds the content of all ACF fields to the Yoast SEO score analysis.

== Description ==
[Yoast SEO\'s](https://yoast.com/wordpress/plugins/) score analysis does not take in to account the content of a post\'s [Advanced Custom Fields](http://www.advancedcustomfields.com/). This plugin uses Yoast 3.0\'s plugin system to hook into the analyser in order to add ACF content to the SEO analysis.
